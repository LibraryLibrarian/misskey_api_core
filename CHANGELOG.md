...
### Changed
- Removed Flutter SDK dependency, converting the package to pure Dart. This allows the library to be used in non-Flutter Dart projects such as CLI tools and server-side applications.
